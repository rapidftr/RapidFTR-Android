...
public class ChildServiceTest {
    ...
    public void shouldParseJsonResponseAndConvertToChildren() throws IOException, JSONException {
        ...
        List<Child> children = new ChildService(mockContext(), repository).getAllChildren();
    ...
    public void shouldFilterChildRecordsThatMatchesSearchString() throws JSONException {
        ...
        List<Child> searchResults = new ChildService(mockContext(), repository).searchChildrenInDB("Hild1");
        assertEquals(2,searchResults.size());
        assertEquals("id1",searchResults.get(0).getId());
        assertEquals("child1",searchResults.get(1).getId());
    }
