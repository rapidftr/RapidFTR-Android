    ...
    protected void initializeView() {
        ...
        findViewById(R.id.submit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AsyncTaskWithDialog.wrap(RegisterChildActivity.this, new SaveChildTask(), R.string.save_child_progress, R.string.save_child_success, R.string.save_child_failure).execute();
            }
        });
    }
